...
Route::group(['middleware' => ['auth']], function() { 
	...
	Route::prefix('admin')
		...
		Route::get('college/create','CollegeController@showForm');
		Route::post('college/create','CollegeController@create');
		Route::get('college/edit/{id}','CollegeController@showEditForm');
		Route::post('college/edit','CollegeController@update');
		Route::get('college/delete/{id}','CollegeController@delete');
