                ...
                <div id="cm-menu-items-wrapper">
                    <div id="cm-menu-scroller">
                        <ul class="cm-menu-items">
                            ...
                            <li class="cm-submenu {{ (Request::segment(2)=='college' ? 'open' : '') }}">
                                <a class="sf-carton">{{ trans('app.college') }} <span class="caret"></span></a>
                                <ul>
                                    <li class="{{ (Request::is('admin/college/create') ? 'active' : '') }}">
                                        <a href="{{ url('admin/college/create') }}">{{ trans('app.add_college') }}</a>
                                    </li>
                                    <li class="{{ (Request::is('admin/college') ? 'active' : '') }}">
