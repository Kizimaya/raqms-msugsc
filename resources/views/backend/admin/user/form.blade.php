...
<div class="panel panel-primary">
    ...
    <div class="panel-body"> 
        {{ Form::open(['url' => 'admin/user/create', 'files' => true, 'class'=>'col-md-7 col-sm-8']) }}
            ...
            <div class="form-group hide @error('college_id') has-error @enderror" id="user_college">
                <label for="college_id">{{ trans('app.college') }} <i class="text-danger">*</i></label> 
                {{ Form::select('college_id', $collegeList, null, ['placeholder' => trans('app.select_option'), 'class'=>'select2 form-control']) }}<br/>
...
$(document).ready(function() {
    ...
    var user_college    = $("#user_college");

    if ("{{ old('user_type') }}" == "1") {
            user_college.removeClass('hide');
    }
