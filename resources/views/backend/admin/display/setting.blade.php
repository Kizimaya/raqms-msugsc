...
<div class="panel panel-primary" id="printMe">
    ...
    <div class="panel-body"> 
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group @error('show_college') has-error @enderror">
                <label for="show_college">{{ trans('app.show_college') }}</label>
                <div id="show_college">  
                    <label class="radio-inline">
                        <input type="radio" name="show_college" value="1" {{ (($setting->show_college)=='1')?"checked":"" }}> {{ trans('app.active') }}
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="show_college" value="0" {{ (($setting->show_college)=='0')?"checked":"" }}> {{ trans('app.deactive') }}
                    </label> 
                </div>
            </div> 
