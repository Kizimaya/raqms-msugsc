        ...
        <table class="dataTables-server display table table-bordered" width="100%" cellspacing="0">
            <thead>
                ...
                <tr>
                    <th></th>
                    <th> 
                        {{ Form::select('college', $colleges, null, ['id'=>'college', 'class'=>'select2 filter', 'placeholder'=> trans('app.college')]) }} 
                    </th>  
                    <th> 
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body"> 
        ...
        <p>
            <label for="college_id" class="control-label">{{ trans('app.college') }} </label>
    ...
    $("body").on("click", ".tokenPrint", function(e) { 
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                content += "<li><strong>{{ trans('app.college') }} </strong>"+data.college+"</li>";
