...
{ 
	...
	{   
    	...
    	return view('backend.admin.user.list', compact('colleges'));
	}
        ...
        if(!empty($users))
        {
            ...
            {  
                $data[] = [
                    ...
                    'email'      => $user->email,
                    'college'    => (!empty($user->college)?$user->college->name:null),
                    'mobile'     => $user->mobile,
    ...
    {
        $collegeList = College::where('status', 1)
            ->pluck('name','id'); 
    	return view('backend.admin.user.form', compact('collegeList'));
    }
    ...
    { 
        ...
        ->setAttributeNames(array(
           ...
           'college_id' => trans('app.college_id'),
    ...
    public function view($id = null)
    {
        $user = User::select(
            ...
            )->leftJoin('college', 'user.college_id', '=', 'college.id')
            ->where('user.id', $id)
            ->first(); 
