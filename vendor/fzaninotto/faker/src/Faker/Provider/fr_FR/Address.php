...
class Address extends \Faker\Provider\Address
{
    ...
    /**
     * Randomly returns a french college ('collegeNumber' => 'collegeName').
     *
    ...
    /**
     * Randomly returns a french college name.
     *
     * @example 'Ardèche'
     *
     * @return string
     */
    public static function collegeName()
    {
        $randomCollegeName = array_values(static::college());

        return $randomCollegeName[0];
    }

    /**
     * Randomly returns a french college number.
     *
     * @example '59'
     *
     * @return string
     */
    public static function collegeNumber()
    {
        $randomCollegeNumber = array_keys(static::college());

        return $randomCollegeNumber[0];
    }
}
