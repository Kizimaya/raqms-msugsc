...
// Generates a random college name
echo $faker->collegeName; // "Haut-Rhin"

// Generates a random college number
echo $faker->collegeNumber; // "2B"

// Generates a random college info (college number => college name)
$faker->college; // array('18' => 'Cher');
